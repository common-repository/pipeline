...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PublishFunnel_vue_vue_type_style_index_0_id_c82cce3a_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("7bf0");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PublishFunnel_vue_vue_type_style_index_0_id_c82cce3a_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PublishFunnel_vue_vue_type_style_index_0_id_c82cce3a_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
var Appvue_type_template_id_e9adf73e_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('Settings',{attrs:{"enableTextWidget":_vm.settings.enable_text_widget,"apiKey":_vm.settings.api_key,"baseURL":_vm.settings.base_URL}})],1)}
var staticRenderFns = []
...
var getApiURL = function getApiURL(endpoint, data) {
  ...
  var pl_admin_settings = window.pl_admin_settings;
  var apiURL = "".concat(pl_admin_settings.proxy_url, "?endpoint=").concat(encodeURIComponent(endpoint), "&_wpnonce=").concat(pl_admin_settings.nonce, "&direct_endpoint=").concat(String(directEndpoint));
...
var COLUMNS_KEYS = {
  STEP_NAME: "pl_step_name",
  FUNNEL_NAME: "pl_funnel_name",
  PAGE_URL: "url",
  EDIT_URL: "edit_url",
  ...
  Object(createClass["a" /* default */])(AddFunnelModal, [{
    ...
    value: function mounted() {
      ...
      if (this.editPost) {
        ...
        if (this.editPost.pl_funnel_id) {
          this.selectedFunnel = this.editPost.pl_funnel_id;
          this.onFunnelChange(this.selectedFunnel);
        }

        if (this.editPost.pl_step_id) {
          this.selectedStep = this.editPost.pl_step_id;
          this.pagePreviewURL = "".concat(this.host_url, "/v2/preview/").concat(this.editPost.pl_step_id);
        }

        if (this.editPost.pl_display_method) {
          this.selectedMethod = this.editPost.pl_display_method;
        }

        if (!this.editPost.pl_include_tracking_code || this.editPost.pl_include_tracking_code === "0") {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return fetch(getApiURL("wp_insert_post"), {
                  method: "POST",
                  body: JSON.stringify({
                    pl_step_url: this.pagePreviewURL,
                    pl_slug: this.pageSlug,
                    pl_step_id: (_this$selecetdStepDet = this.selecetdStepDetails) === null || _this$selecetdStepDet === void 0 ? void 0 : _this$selecetdStepDet.id,
                    pl_funnel_id: (_this$selecetdFunnelD = this.selecetdFunnelDetails) === null || _this$selecetdFunnelD === void 0 ? void 0 : _this$selecetdFunnelD.id,
                    pl_step_name: (_this$selecetdStepDet2 = this.selecetdStepDetails) === null || _this$selecetdStepDet2 === void 0 ? void 0 : _this$selecetdStepDet2.name,
                    pl_funnel_name: (_this$selecetdFunnelD2 = this.selecetdFunnelDetails) === null || _this$selecetdFunnelD2 === void 0 ? void 0 : _this$selecetdFunnelD2.name,
                    template_id: this.editablePost && this.editPost ? this.editPost.template_id : -1,
                    pl_display_method: this.selectedMethod,
                    pl_step_meta: (_this$selecetdStepDet3 = this.selecetdStepDetails) === null || _this$selecetdStepDet3 === void 0 ? void 0 : _this$selecetdStepDet3.meta,
                    pl_step_page_download_url: (_this$selecetdStepDet4 = this.selecetdStepDetails) === null || _this$selecetdStepDet4 === void 0 ? void 0 : _this$selecetdStepDet4.pageDataDownloadURL,
                    pl_include_tracking_code: this.includeTrackingCode,
                    pl_funnel_tracking_code: {
...
// EXTERNAL MODULE: ./src/components/PublishFunnel.vue?vue&type=style&index=0&id=c82cce3a&scoped=true&lang=scss&
var PublishFunnelvue_type_style_index_0_id_c82cce3a_scoped_true_lang_scss_ = __webpack_require__("ac05");
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  PublishFunnelvue_type_template_id_c82cce3a_scoped_true_render,
  PublishFunnelvue_type_template_id_c82cce3a_scoped_true_staticRenderFns,
  false,
  null,
  "c82cce3a",
  null
...
var Settingsvue_type_script_lang_ts_PipeLineSettings = /*#__PURE__*/function (_Vue) {
  Object(inherits["a" /* default */])(PipeLineSettings, _Vue);

  var _super = Object(createSuper["a" /* default */])(PipeLineSettings);

  function PipeLineSettings() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, PipeLineSettings);
  ...
  Object(createClass["a" /* default */])(PipeLineSettings, [{
    ...
    value: function () {
      var _saveAPI = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regeneratorRuntime.mark(function _callee(enableTextWidget) {
        var _pipeLineSeeting;

        var body, pipeLineSeetings, response;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 8:
                pipeLineSeetings = _context.sent;
                console.log(pipeLineSeetings);

                if (!((_pipeLineSeeting = pipeLineSeetings) !== null && _pipeLineSeeting !== void 0 && _pipeLineSeeting.ok)) {
                  _context.next = 18;
                  break;
                }

                _context.next = 13;
                return pipeLineSeetings.json();
              ...
              case 18:
                if (pipeLineSeetings.status === 404) {
                  this.isvalidApi = false;
    ...
    value: function () {
      var _fetchUserSettings = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(onSuccess) {
        var pipeLineSeetings, response;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return fetch(getApiURL("wp_get_pl_options"));

              case 2:
                pipeLineSeetings = _context3.sent;

                if (!pipeLineSeetings.ok) {
                  _context3.next = 17;
                  break;
                }
...
Object(tslib_es6["a" /* __decorate */])([Object(lib["b" /* Prop */])()], Settingsvue_type_script_lang_ts_PipeLineSettings.prototype, "enableTextWidget", void 0);

Object(tslib_es6["a" /* __decorate */])([Object(lib["b" /* Prop */])()], Settingsvue_type_script_lang_ts_PipeLineSettings.prototype, "apiKey", void 0);

Object(tslib_es6["a" /* __decorate */])([Object(lib["b" /* Prop */])()], Settingsvue_type_script_lang_ts_PipeLineSettings.prototype, "baseURL", void 0);

Object(tslib_es6["a" /* __decorate */])([Object(lib["d" /* Watch */])("enableTextWidget")], Settingsvue_type_script_lang_ts_PipeLineSettings.prototype, "onEnableTextWidget", null);

Object(tslib_es6["a" /* __decorate */])([Object(lib["d" /* Watch */])("apiKey")], Settingsvue_type_script_lang_ts_PipeLineSettings.prototype, "onApiKey", null);

Settingsvue_type_script_lang_ts_PipeLineSettings = Object(tslib_es6["a" /* __decorate */])([Object(lib["a" /* Component */])({
  components: {
    PublishFunnel: PublishFunnel
  }
})], Settingsvue_type_script_lang_ts_PipeLineSettings);
/* harmony default export */ var Settingsvue_type_script_lang_ts_ = (Settingsvue_type_script_lang_ts_PipeLineSettings);
...
var Appvue_type_script_lang_ts_App = /*#__PURE__*/function (_Vue) {
  ...
  Object(createClass["a" /* default */])(App, [{
    key: "mounted",
    value: function mounted() {
      var settingsHolderElement = document.getElementById("pipe-line-settings-holder");
